            ...
            <div class="container-fluid">		
                <div class="shop-style-all">
                    ...
                    <div class="row">
                        <div class="grid">
                        @if(!Auth::guest())
                            @foreach( Auth::user()->prod_user as $prod_u)

                                <div class="col-md-3 col-sm-6 col-xs-12 grid-item cat1">
                                    <div class="shop-img">
                                            <img src="uplaod/{{$prod_u->prod->img}}" alt="" />	
                                    </div>	
                                    <!-- Title -->
                                    <h1 class="title">{{$prod_u->prod->name}}</h1>
                                    <!-- Price Ratting -->
                                    <div class="price-ratting section">
                                        <!-- Price -->
                                        <span class="price float-left"><span class="new">€ {{$prod_u->prod->price}}</span></span>
                                    ...
                                    <div class="short-desc section">
                                        ...
                                        <p style="color: red;"><b>{{$prod_u->prod->created_at}}</b></p>
                                    </div>		
                                    <!-- Short quantity-->
